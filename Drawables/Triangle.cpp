...
Triangle::Triangle() {
	Vertex v1 = Vertex(0.0, 0.5, 0.0, 0.0, 1.0, 0.0);
	Vertex v2 = Vertex(-0.5, -0.5, 0.0, 0.0, 1.0, 0.0);
	Vertex v3 = Vertex(0.5, -0.5, 0.0, 0.0, 1.0, 0.0);
	_triangle = new GLTriangle(v1, v2, v3);
	_l1 = new GLLine(v1, v2);
	_l2 = new GLLine(v2, v3);
	_l3 = new GLLine(v3, v1);
...
void Triangle::setTransformed(Drawable* transformed) {
	_transformed = (Triangle*) transformed;
}
